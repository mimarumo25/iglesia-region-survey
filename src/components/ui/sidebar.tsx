...
const SIDEBAR_WIDTH_EXPANDED = "22rem"
const SIDEBAR_WIDTH_MOBILE = "18rem"
const SIDEBAR_WIDTH_MOBILE_EXPANDED = "24rem"
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          ...
          >
            ...
            <SheetDescription className="sr-only">Navegación principal del sistema</SheetDescription>
