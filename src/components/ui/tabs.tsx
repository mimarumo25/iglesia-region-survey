...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-2xl border border-border/70 bg-card/95 p-1.5 text-muted-foreground shadow-sm",
      className
    )}
    {...props}
  />
